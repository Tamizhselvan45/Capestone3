...
if selected == "Home":
    ...
    with col2:
        st.image("C:\\Users\\Sathya\\Downloads\\Creative Modern Business Card\\Home.png")
...
if selected == "Upload & Extract":
    ...
    if uploaded_card is not None:
        ...
        def save_card(uploaded_card):
            with open(os.path.join("C:\\Users\\Sathya\\Downloads\\",uploaded_card.name), "wb") as f:
        ...
        with col2:
            ...
            with st.spinner("Please wait processing image..."):
                ...
                saved_img = os.getcwd()+ "\\" + "Creative Modern Business Card"+ "\\"+ uploaded_card.name
    ...
    try:
        with column1:
            ...
            if st.button("Commit changes to DB"):
                ...
                mycursor.execute("""UPDATE card_data SET                          company_name=%s,card_holder=%s,designation=%s,mobile_number=%s,email=%s,website=%s,area=%s,city=%s,state=%s,pin_code=%s WHERE card_holder=%s""", (company_name,card_holder,designation,mobile_number,email,website,area,city,state,pin_code,selected_card))
                mydb.commit()
